...
func _init() -> void:
	...
	add_particle_process_material(preload("res://objects/terrain/finish-zone-particles.tres"))
	add_canvas_item_shader_material(preload("res://objects/ball/ball-material.tres"))
	add_canvas_item_shader_material(preload("res://objects/terrain/finish-zone-material.tres"))
